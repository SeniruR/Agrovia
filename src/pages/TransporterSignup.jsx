...
const TransporterSignup = () => {
    ...
    const validateForm = () => {
        ...
        if (formData.maxTravelDistance && (isNaN(formData.maxTravelDistance) || parseFloat(formData.maxTravelDistance) <= 0)) newErrors.maxTravelDistance = 'Please enter a valid travel distance';
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-green-200 overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="p-8 space-y-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="flex gap-2">
                                    <div className="flex-1">
                                        <InputField icon={Gauge} label="Vehicle Capacity" name="vehicleCapacity" required type="number" step="0.01" placeholder="Enter capacity" value={formData.vehicleCapacity} error={errors.vehicleCapacity} onChange={handleInputChange} />
                                    </div>
                                    <div className="w-32">
                                        <InputField label="Unit" name="capacityUnit" options={capacityUnits} value={formData.capacityUnit} error={errors.capacityUnit} onChange={handleInputChange} />
                                    </div>
                                </div>
                                <div className="flex gap-2">
                                    <div className="flex-1">
                                        <InputField icon={Ruler} label="Max Travel Distance" name="maxTravelDistance" required type="number" step="0.1" placeholder="Enter distance" value={formData.maxTravelDistance} error={errors.maxTravelDistance} onChange={handleInputChange} />
                                    </div>
                                    <div className="w-32">
                                        <InputField label="Unit" name="distanceUnit" options={distanceUnits} value={formData.distanceUnit} error={errors.distanceUnit} onChange={handleInputChange} />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <InputField icon={Award} label="Years of Experience" name="experienceYears" required options={experienceOptions} value={formData.experienceYears} error={errors.experienceYears} onChange={handleInputChange} />
