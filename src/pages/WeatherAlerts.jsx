    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {accessLoading ? (
          ...
          <div className="text-center py-16">
            <div className="bg-white rounded-3xl shadow-xl border border-blue-200 p-12 max-w-2xl mx-auto">
              <div className="mb-8">
                <div className="bg-gradient-to-br from-blue-100 to-blue-200 p-6 rounded-2xl w-24 h-24 mx-auto mb-6 flex items-center justify-center">
                  <Lock className="w-12 h-12 text-blue-600" />
                </div>
                <h3 className="text-3xl font-bold text-gray-900 mb-4">Premium Feature</h3>
                <p className="text-lg text-gray-600 mb-6">
                  Weather Alert System requires a premium subscription with alert access. 
                  Upgrade your plan to get intelligent weather monitoring and farming recommendations.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-2xl p-6 mb-8">
                ...
                <ul className="text-sm text-green-700 space-y-2">
                  <li>• Real-time weather alerts and warnings</li>
                  <li>• Crop-specific weather recommendations</li>
                  <li>• Advanced forecasting for optimal planting</li>
                  <li>• Extreme weather protection strategies</li>
                  <li>• Location-specific meteorological data</li>
                </ul>
              </div>
